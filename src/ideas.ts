...
export const ideas: Idea[] = [
  ...
  },
  {
    ...
    title: '割り振らないサンキー',
    motion:
      '原資は1本の柱のまま、どこへ何が流れたかは割り振らない。すきまを行き先の側にだけ空けると、太さを1pxも変えずに板が流れの形へ戻る',
    /* No.64 の続き。あちらは対応が実在する題材だったが、こちらは対応が決まっていない
       （赤字の週の現金に色は付いていない）。正直に描くと左右が同じ積みになって
       帯が1本も曲がらず、サンキーが「灰色の板」になる——その失敗をそのまま対照に持つ。 */
    tags: ['アナリティクス', 'グラフ', 'フロー', '対照'],
    status: 'captured',
    specimenId: 'sankey-unassigned',
  },
  {
    id: 'area-tide',
    title: 'エリアチャートの満ち引き',
