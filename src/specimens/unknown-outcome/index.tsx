...
/* ---- No.122「届いたかどうか分からない」----
   ...
   3. レール(下地)の色を対照の「失敗」色(赤)と混同しないよう、灰色
      ...
      ──既定はモノクロを最後まで貫く必要がある。
   4. MAX_ATTEMPTS(=3)に達すると主ボタンをdisabledにする。これは「再送させない」
      とは別の理由(画面サイズの都合)なので、ラベルは変えず「週を提出する」のまま
      disabledにした──ラベルを変えて理由をこじつけると、企画が禁じた「別の意味を
      持つ担体の使い回し」に近づいてしまうため。 */
...
const MAX_ATTEMPTS = 3 // 画面の外形(320x250px以内)を守るための表示上限
