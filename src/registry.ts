...
export const specimens: Specimen[] = [
  ...
  },
  {
    ...
    category: 'ナビゲーション',
    trigger: '親の行の ▸ を押して畳む／開く。畳んだ親に湧く「中に」の担体を押すと開いて現在地へ戻る（右上で対照に切り替え）',
    principles: ['内側に方角は無い', '代弁する担体は、現在地の担体と別のものにする', '畳む操作は現在地を狙っていない'],
    ecology: 'TODO（実装後に実測値で書く）',
  ...
  },
  {
    ...
    category: 'ナビゲーション',
    trigger: '流れ続けるログを上へスクロールして追従を外す。下の戻り道を押して追いつく（右上で対照に切り替え）',
  ...
  },
  {
    ...
    category: 'ナビゲーション',
    trigger: '「320行目へ」を押して未読込の領域へ現在地を送る。取り寄せに失敗したら担体自身の再取得を押す（右上で対照に切り替え）',
